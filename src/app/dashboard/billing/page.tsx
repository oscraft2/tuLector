...
export default async function BillingPage() {
  ...
  return (
    <DashboardShell locale={locale} title={t.billing} description="Plan, cuota de lecturas, compras de scans y facturas. Stripe queda conectado solo por rutas server-side.">

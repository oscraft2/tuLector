  ...
  return {
    ...
    alternates: {
      ...
      languages: Object.fromEntries([
        ...locales.map((l) => [l, `${siteUrl}/${l}/security`]),
        ["x-default", `${siteUrl}/es-MX/security`],
      ]),
    },
  };
}
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  return <PublicInfoPage pageKey="security" locale={newLocaleToLegacy(locale)} currentLocale={locale} />;
}

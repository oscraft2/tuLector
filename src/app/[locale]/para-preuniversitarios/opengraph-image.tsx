...
export const alt = "TuLector para Preuniversitarios";
    ...
    (
      <div style={{ display: "flex", flexDirection: "column", background: "#111827", color: "#fff", width: "100%", height: "100%", padding: 60, justifyContent: "space-between", fontFamily: "system-ui, sans-serif" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <div style={{ display: "flex", fontSize: 24, color: "#22d3ee", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase" }}>Para Preuniversitarios</div>
          <div style={{ display: "flex", fontSize: 60, fontWeight: 800, lineHeight: 1.15 }}>{copy.paraPreuniversitarios.h1}</div>
        </div>

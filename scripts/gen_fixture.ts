...
drawSheet(ctx as unknown as Ctx2D, { answers, rut, filled: true });
...
// Hoja TuLector v2 (anclas solidas + pista de temporizacion + RUT).
...
console.log(`Fixture regenerado: ${base64.length} chars b64, ${expAnswers.length} respuestas, RUT ${rut}`);
